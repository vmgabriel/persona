...
class SteresCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personas:steress")
...
def delete_steres_view(request, pk):
    ...
    steres.delete()
    return redirect("personas:steress")
...
class UserCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personas:users")
...
class PreductsCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personas:preductss")
...
def delete_preducts_view(request, pk):
    ...
    preducts.delete()
    return redirect("personas:preductss")
...
class SheppingcartCreateView(LoginRequiredMixin, generic.CreateView):
    ...
    success_url = reverse_lazy("personas:sheppingcarts")
...
def delete_sheppingcart_view(request, pk):
    ...
    sheppingcart.delete()
    return redirect("personas:sheppingcarts")
